...
unsigned long endTime = 100000; // in millis
...
void driveCart() {
  ...
  if(timeChangeCart > 500){ch = 0; analogWrite(driverPWMpinLeft, zeroSpeed); analogWrite(driverPWMpinRight, zeroSpeed);} 
