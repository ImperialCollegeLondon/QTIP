...
void feedbackLoop(){
   ...
   thirdESCSpeed = (kp * sin(rollError*M_PI/180) + ki * rollErrSum - kd * dRoll/timeChange/1000);
   ...
   fourthESCSpeed = -(kp * sin(rollError*M_PI/180) + ki * rollErrSum - kd * dRoll/timeChange/1000);
  ...
  /*Pitch feedback*/
   ...
   firstESCSpeed = (kp * sin(pitchError*M_PI/180) + ki * pitchErrSum - kd * dPitch/timeChange/1000);
   ...
   secondESCSpeed = -(kp * sin(pitchError*M_PI/180) + ki * pitchErrSum - kd * dPitch/timeChange/1000);
...
void printData() {
  ...
  Serial.print(kp* sin(rollError*M_PI/180));
  Serial.print("  Integral: ");
  Serial.print(ki * rollErrSum);
  Serial.print("  Derivative ");
  Serial.println(-kd * dRoll/timeChange/1000);
  //*/
