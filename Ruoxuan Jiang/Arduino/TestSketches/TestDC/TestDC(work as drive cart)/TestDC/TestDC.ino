// TestDC.ino
// ver. 1.3 (stable)
// taken from DriveCart.ino to test if DC motors are functional.
// to be loaded on Arduino Mega
// also can be used to check the relationship of motor directions and
// direction pins states
...
//  analogWrite(driverPWMpinLeft, 100);
//  delay(2000);
//  analogWrite(driverPWMpinLeft, 0);
//  delay(1000);
//  Serial.print("Testing right motor... \t");
//  analogWrite(driverPWMpinRight, 100);
//  analogWrite(driverPWMpinLeft, 0);
//  delay(2000);
//  analogWrite(driverPWMpinRight, 0);
//  delay(1000);

  Serial.print("Test both... \t");
  analogWrite(driverPWMpinLeft, 80);
  analogWrite(driverPWMpinRight, 80);
  delay(4000);
  analogWrite(driverPWMpinLeft, 0);
  analogWrite(driverPWMpinRight, 0);
  delay(1000);
