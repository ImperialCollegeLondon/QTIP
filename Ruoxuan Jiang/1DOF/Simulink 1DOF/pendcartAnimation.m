function [sys,str,ts,simStateCompliance] = pendcartAnimation(t,u,flag,RefBlock)
...
switch flag,
  ...
  %%%%%%%%%%%%%%%%%%
  case 0,
    [sys,str,ts,simStateCompliance]=mdlInitializeSizes(RefBlock);
...
%=============================================================================
%
function [sys,str,ts,simStateCompliance]=mdlInitializeSizes(RefBlock)
...
%=============================================================================
%
function sys=mdlUpdate(t,u) %%#ok<INUSL>
...
uicontrol(...
  ...
  'String',  'Playback', ...
  'Callback','pendcartAnimation([],[],[],''Playback'');',...
  'Interruptible','off',...
  'BusyAction','cancel', ...
